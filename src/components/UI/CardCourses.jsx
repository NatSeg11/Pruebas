...
export function CardCourses({title, description, image, progress}) {
    return(
        <NavLink to="/attimo/courseDetails" className="bg-white dark:bg-clr-dark-third rounded-lg overflow-hidden dark:hover:brightness-125 hover:brightness-[.80] transition duration-300 cursor-pointer">
